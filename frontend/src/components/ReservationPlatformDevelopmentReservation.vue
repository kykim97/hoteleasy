<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <Hotel offline label="Hotel" v-model="value.hotel" :editMode="editMode" @change="change"/>
            <String label="Room Type" v-model="value.roomType" :editMode="editMode" :inputUI="''"/>
            <Payment offline label="Payment Details" v-model="value.paymentDetails" :editMode="editMode" @change="change"/>
        </v-card-text>
...
<script>
    ...
    export default {
        name: 'ReservationPlatformDevelopmentReservation',
        components:{
            User,
            Payment,
        },
