<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <Hotel offline label="Hotel" v-model="item.hotel" :editMode="false" :key="false" @change="change" />
            <div>
                <String label="RoomType" v-model="item.roomType" :editMode="editMode" @change="change" />
            </div>
            <Payment offline label="PaymentDetails" v-model="item.paymentDetails" :editMode="false" @change="change" />
        </v-card-text>
